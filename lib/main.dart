...
class Calculator extends StatefulWidget { //Class Calculator adalah widget stateful karen amemiliki nilai yang selalu berubah ketika tombolnya ditekan
  @override
  _CalculatorState createState() => _CalculatorState();
}

class _CalculatorState extends State<Calculator> {
  String output = "0"; //Output merupakan variabel yang menampung nilai yang akan ditampilkan kdi kalkulator
      ...
      child: Padding(
        ...
        child: ElevatedButton( //digunakan untuk membuat tombol dengan gaya tertentu
          style: ElevatedButton.styleFrom(
            padding: EdgeInsets.symmetric(vertical: 22), //digunakan untuk mengatur jarak dalam tombol secara vertical menjadi 22 sehingga tombol terliohat tinggi
  ...
  Widget build(BuildContext context) { //fungsi build digunakan untuk membuat tampilan utama
    return Scaffold( //digunakan untuk membuat struktur dasar untuk halaman
      body: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch, //tanpa CrossAxisAlignment.stretch, tombol-tombol tersebut akan memiliki lebar sesuai dengan ukuran teksnya masing-masing atau pengatruan default widget tombol\
        children: <Widget>[
          Expanded(
            child: Container(
